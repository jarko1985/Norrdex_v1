...
import flag from "../../images/visa/turkey.svg";
class TurkeyV extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="container">
        <section className="services">
          <img src={flag} width="200px" height="150px" alt="turkey-visa" />
        ...
        <form
          ...
          action="https://formspree.io/f/mayppeky"
          method="POST"
        >
